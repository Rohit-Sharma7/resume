            ...
            <div class="container-fluid p-0">
                ...
                <section class="resume-section" id="about">
                    <div class="resume-section-content">
                        ...
                        <br></br>
                        <p class="lead mb-5">9096381131<br></br>rs1041762@gmail.com</p>
                        <span class="subheading mb-5">
                            Objective :
                        </span>
                        <p class="lead mb-5">
                            To work in a challenging and dynamic environment to keep adding value to the organization that I represent and serve,   while also concurrently upgrading skills and knowledge
                        </p>
                        <div class="social-icons">
                            <a class="social-icon" href="https://www.linkedin.com/in/rohit-sharma-93198b262/">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a class="social-icon" href="https://github.com/Rohitsharma9096381131">
